...
public class AddNewProductShopManagerModelManager
    implements AddNewProductShopManagerModel
{
  ...
  {
    return client
        .addNewProductShopManager(productName, productDescription, category,
            parseTag, price);
  }
  ...
  @Override public ArrayList<Product> getAllProductsFor()
  {
  ...
  @Override public int getUserId(String username)
  {
