...
//                        if (!category.isEmpty()) {
//                            if (!tags.isEmpty()) {
//                                if (!priceTextField.getText().isEmpty() && price > 0 && price != productSelected.getPrice()) {
//
//                                    int productid = productSelected.getProductId();
//                                            ArrayList<String> parseTag = new ArrayList<>(tags);
//                                    String response = addNewProductShopManagerViewModel.editNewProduct(clientUsername, productName, productDescription, category, parseTag, price, productid);
//
//                                    if (response.equals("Product edited"))
//                                        viewHandler.openShopManagerView();
//                                    else {
//                                        errorLabel.setText(response);
//                                    }
