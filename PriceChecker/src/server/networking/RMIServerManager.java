...
public class RMIServerManager implements RMIServer
{
 ...
 private AddNewProductShopManagerServerModel addNewProductShopManagerServerModel;
  ...
  public RMIServerManager(LoginRegisterServerModel loginRegisterServerModel, AdministratorServerModel administratorServerModel,
      ...
      EditProductShopManagerServerModel editProductShopManagerServerModel,AddNewProductShopManagerServerModel addNewProductShopManagerServerModel) throws RemoteException
  {
    ...
    @Override
    public ProductList loadProductData() throws RemoteException {
    ...
    @Override
    public String addNewTag(String newTag) throws RemoteException {
    ...
    @Override
    public String deleteProduct(int productId) throws RemoteException {
        return administratorServerModel.deleteProduct(productId);
    }

    @Override
    public void logOut(ClientCallback client) throws RemoteException {
    ...
    @Override
    public ArrayList<Product> getAllProductsForSpecificManager(
            String username) throws RemoteException {
        return shopManagerServerModel.getAllProductsForSpecificManager(username);
    }

    @Override
    public String deleteProductPrice(int productId, String username) throws RemoteException {
        return null;
    }
    ...
    @Override
    public String addNewManager(User newManager) throws RemoteException {
        return null;
    }
  ...
  @Override public void registerClient(ClientCallback client) throws RemoteException
  {
    ...
    editProductShopManagerServerModel.addListener(EventType.EDIT_SHOP_MANAGER_PRODUCT.name(),listener);
      addNewProductShopManagerServerModel.addListener(EventType.NEW_PRODUCT_FOR_MANAGER.name(), listener);
